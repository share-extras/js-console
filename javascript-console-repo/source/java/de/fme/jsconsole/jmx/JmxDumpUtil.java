...
public class JmxDumpUtil {
	...
	public static List<String> getAllAttributeNames(MBeanServerConnection connection, ObjectName objectName) throws IOException,
			JMException {
	...
	public static void printCompositeInfo(CompositeData composite, PrintWriter out, int nestLevel) throws IOException {
		Map<String, Object> attributes = new TreeMap<String, Object>();
	 ...
	 *             Signals that an I/O exception has occurred.
	 */
	public static void tabulate(String keyHeader, String valueHeader, Map<String, Object> rows, PrintWriter out, int nestLevel)
			throws IOException {
		if (rows.isEmpty()) {
			return;
		}
